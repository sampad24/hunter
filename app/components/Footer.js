...
const Footer = () => {
  return (
    <footer className="bg-black">
      ...
      <div className='back1 py-16 px-4 sm:px-10 md:px-[10%] lg:px-[20%]'>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Company Info */}
          <div className="space-y-4">
            <h3 className="text-white text-xl font-bold mb-4">JGVFX</h3>
            <p className="text-gray-300">
              Professional VFX training institute dedicated to nurturing creative talents in the world of visual effects.
            </p>
      ...
      <div className="bg-white h-0.5 opacity-100 left-0"></div>
      

      {/* Copyright */}
      <div className='text-center py-6 border-t border-gray-800'>
        <p className='text-gray-400'>© {new Date().getFullYear()} JGVFX. All rights reserved.</p>
        <p className='text-white m-2'>Created By Sampad Mukherjee</p>
      </div>
    </footer>
  )
}
